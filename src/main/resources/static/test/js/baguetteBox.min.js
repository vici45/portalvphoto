...
!function (t, e) {
    ...
    function i() {
        if (S = T("baguetteBox-overlay")) return P = T("baguetteBox-slider"), F = T("previous-button"),DL=T("dowload-button"),H = T("next-button"), void(L = T("close-button"));
        S = N("div"), S.setAttribute("role", "dialog"), S.id = "baguetteBox-overlay", document.getElementsByTagName("body")[0].appendChild(S),
            ...
            DL=N("span"),DL.id="download-button",DL.innerHTML="请长按照片保存到本地",S.appendChild(DL),
            DL.className=F.className = H.className = L.className = "baguetteBox-button", r()
    }
