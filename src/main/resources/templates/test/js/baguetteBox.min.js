...
!function (t, e) {
    ...
    function i() {
        ...
        S = N("div"), S.setAttribute("role", "dialog"), S.id = "baguetteBox-overlay", document.getElementsByTagName("body")[0].appendChild(S),
            P = N("div"), P.id = "baguetteBox-slider", S.appendChild(P),
            F = N("button"), F.setAttribute("type", "button"), F.id = "previous-button", F.setAttribute("aria-label", "Previous"), F.innerHTML = M.svg ? I : "&lt;", S.appendChild(F),
            H = N("button"), H.setAttribute("type", "button"), H.id = "next-button", H.setAttribute("aria-label", "Next"), H.innerHTML = M.svg ? Y : "&gt;", S.appendChild(H),
            L = N("button"), L.setAttribute("type", "button"), L.id = "close-button", L.setAttribute("aria-label", "Close"),L.setAttribute("onclick","closeFunction()"), L.innerHTML = M.svg ? q : "&times;", S.appendChild(L),
            F.className = H.className = L.className = "baguetteBox-button", r()
    }
    ...
    function u(t, e) {
        if (R !== t) {
            ...
            for (var n, o = [], i = [], a = 0; a < t.length; a++)
                n = N("div"),
                    n.className = "full-image",
                    n.id = "baguette-img-" + a,
                    W.push(n),
                    /*DL=T("picture-caption"), DL=N("span"),DL.id="picture-caption",DL.innerHTML="",n.appendChild(DL),*/
    ...
    function p(t, e) {
        ...
        if (void 0 !== n && void 0 !== o) {
            ...
            if (u.id = "baguetteBox-figure-" + t, u.innerHTML = '<div class="baguetteBox-spinner"><div class="baguetteBox-double-bounce1"></div><div class="baguetteBox-double-bounce2"></div></div>', j.captions && r) {
                ...
                var op=originPicture(i),
                    ops=originPictureSize(i);
            }
            OB=T("original-button"),OB=N("button"), OB.setAttribute("type", "button"), OB.id="original-button",OB.innerHTML="查看原图/"+ops,u.appendChild(OB),
               /* DB=T("download-button"),DB=N("a"), DB.id="download-button",DB.setAttribute("class", "glyphicon glyphicon-save"),DB.setAttribute("href",l+"?attname="),u.appendChild(DB),*/
            TB=T("top-button"),TB.style.display="none",TB=T("refresh-button"),TB.style.display="none",
                OB.onclick=function(){
                    c.setAttribute("src",op);
                    this.innerHTML="当前尺寸为大图";
    ...
    function originPicture(t) {
        var e=t.getAttribute("data-origin");
        return e;
    }
    function originPictureSize(t) {
        var e=t.getAttribute("data-origin-size");
        return e;
    }
    ...
    var S, P, F, H, L,DL,OB,DB,TB,RB,
        I = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',
        ...
        }, M = {}, R = [], z = 0, D = {}, O = !1, V = /.+\.(gif|jpe?g|png|webp| )/i, U = {}, W = [], G = null,
        J = function (t) {
    ...
    return [].forEach || (Array.prototype.forEach = function (t, e) {
        ...
        return o
    }), {run: t, destroy: A, showNext: h, showPrevious: v}
});